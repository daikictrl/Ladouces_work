...
OVERVIEW
--------
The booking flow is a 4-step wizard that lets the user select a destination,
date, 
choose a transport agency, 
choose a bus departure time, 
proceed to seat selection. 
Each step is a separate screen inside the /(tabs)/book stack. A
...
Mens Travel          initials "MT"       premium service
Global Voyage        initials "GV"       regional routes
Blue Bird            initials "BB"       budget option
